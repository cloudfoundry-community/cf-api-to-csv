...
//it ended up being easier to use generic interfaces for the json,
//but this is what the endpoints return should I/you find it useful

// type appsAPIEntity struct {
...
// type serviceBindingsAPIEntity struct {
